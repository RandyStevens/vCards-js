		...
		getFormattedString: function(vCard) {
			...
			if (vCard.cellPhone) {
				...
				vCard.cellPhone.forEach(
					function(number){
						if (majorVersion >= 4) {
							formattedVCardString += 'TEL;TYPE="voice,cell":' + e(number) + nl();
						} else {
			...
			if (vCard.pagerPhone) {
				...
				vCard.pagerPhone.forEach(
					function(number) {
						if (majorVersion >= 4) {
							formattedVCardString += 'TEL;TYPE="pager,cell":' + e(number) + nl();
						} else {
			...
			if (vCard.homePhone) {
				...
				vCard.homePhone.forEach(
					function(number) {
						if (majorVersion >= 4) {
							formattedVCardString += 'TEL;TYPE="voice,home":' + e(number) + nl();
						} else {
			...
			if (vCard.workPhone) {
				...
				vCard.workPhone.forEach(
					function(number) {
						if (majorVersion >= 4) {
							formattedVCardString += 'TEL;TYPE="voice,work":' + e(number) + nl();
			...
			if (vCard.homeFax) {
				...
				vCard.homeFax.forEach(
					function(number) {
						if (majorVersion >= 4) {
							formattedVCardString += 'TEL;TYPE="fax,home":' + e(number) + nl();
			...
			if (vCard.workFax) {
				...
				vCard.workFax.forEach(
					function(number) {
						if (majorVersion >= 4) {
							formattedVCardString += 'TEL;TYPE="fax,work":' + e(number) + nl();
			...
			if (vCard.otherPhone) {
				...
				vCard.otherPhone.forEach(
					function(number) {
						if (majorVersion >= 4) {
							formattedVCardString += 'TEL;TYPE="voice,other":' + e(number) + nl();
